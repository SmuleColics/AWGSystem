      ...
      <div class="flex ">
        <div class="bg-white p-4 rounded-3 login-container">
          ...
          <form action="">
            ...
            <div class="mb-3 position-relative"> <label   for="login-pword" class="form-label fs-14 fw-500">Password</label> <input type="password" class="form-control fs-14" id="login-pword" placeholder="••••••••" autocomplete="current-password" aria-describedby="togglePassword" /> <button type="button" id="togglePassword" class="btn password-toggle" aria-label="Show password" aria-pressed="false" title="Show password" > <i class="fas fa-eye" aria-hidden="true"></i> </button> 
            </div>
